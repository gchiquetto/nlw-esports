                ...
                <Dialog.Title className='text-3xl font-black'>Publish here an Ad</Dialog.Title>
                    <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Input name="name" id="name" type="text" placeholder="How are you called inside the game?" />
                        </div>
                        
                        <div className="grid grid-cols-2 gap-6">
                            <div className="flex flex-col gap-2">
                                <label htmlFor="yearsPlaying">Time playing this game?</label>
                                <Input name="yearsPlaying" id="yearsPlaying" type="numer" placeholder="It's okay to be zero" />
                            </div>
                            <div className="flex flex-col gap-2">
